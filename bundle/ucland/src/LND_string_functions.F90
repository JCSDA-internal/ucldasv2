...
logical function string_functions_unit_tests(verbose)
  ...
  fail = .false.
  v = verbose
  write(stdout,*) '==== LND_string_functions: string_functions_unit_tests ==='
...
!!  require any other LND software to be useful.

end module LND_string_functions
