...
module UCLAND_string_functions
...
logical function string_functions_unit_tests(verbose)
  ...
  fail = .false.
  v = verbose
  write(stdout,*) '==== UCLAND_string_functions: string_functions_unit_tests ==='
...
!!  character strings.   Although they are a part of UCLAND, the do not
!!  require any other UCLAND software to be useful.

end module UCLAND_string_functions
