...
public LND_error, LND_mesg, NOTE, WARNING, FATAL, is_root_pe, stdlog, stdout
public LND_set_verbosity, LND_get_verbosity, LND_verbose_enough
...
subroutine LND_mesg(message, verb, all_print)
...
end subroutine LND_error

!> This subroutine sets the level of verbosity filtering LND error messages
subroutine LND_set_verbosity(verb)
  ...
  if (verb>0 .and. verb<10) then
    ...
    call LND_error(FATAL,msg)
  endif
end subroutine LND_set_verbosity

!> This subroutine gets the level of verbosity filtering LND error messages
function LND_get_verbosity()
  integer :: LND_get_verbosity
  LND_get_verbosity = verbosity
end function LND_get_verbosity

!> This tests whether the level of verbosity filtering LND error messages is
!! sufficient to write a message of verbosity level verb
function LND_verbose_enough(verb)
  integer, intent(in) :: verb !< A level of verbosity to test
  logical :: LND_verbose_enough
  LND_verbose_enough = (verbosity >= verb)
end function LND_verbose_enough
