...
#ifndef MYMODEL_GETVALUES_LINEARGETVALUES_H_
#define MYMODEL_GETVALUES_LINEARGETVALUES_H_
...
namespace mymodel {
  ...
  class LinearGetValues : public util::Printable,
   ...
   public:
    static const std::string classname() {return "mymodel::LinearGetValues";}
...
#endif  // MYMODEL_GETVALUES_LINEARGETVALUES_H_
