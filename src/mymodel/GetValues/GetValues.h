...
#ifndef MYMODEL_GETVALUES_GETVALUES_H_
#define MYMODEL_GETVALUES_GETVALUES_H_
...
namespace mymodel {
  ...
  class GetValues : public util::Printable,
   ...
   public:
    static const std::string classname() {return "mymodel::GetValues";}
...
#endif  // MYMODEL_GETVALUES_GETVALUES_H_
