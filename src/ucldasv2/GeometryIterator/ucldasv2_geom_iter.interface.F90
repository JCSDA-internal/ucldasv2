...
subroutine ucldasv2_geom_iter_setup_c(c_key_self, c_key_geom, c_iindex, c_jindex, c_kindex) bind(c, name='ucldasv2_geom_iter_setup_f90')
...
subroutine ucldasv2_geom_iter_current_c(c_key_self, c_lon, c_lat, c_lev) bind(c, name='ucldasv2_geom_iter_current_f90')
  ...
  real(c_double), intent(inout) :: c_lev      !< Level
  ...
  ! Call Fortran
  call self%current(c_lon, c_lat, c_lev)
...
subroutine ucldasv2_geom_iter_dimension_c(c_key_self, c_val) bind(c, name='ucldasv2_geom_iter_dimension_f90')
  integer(c_int), intent( in) :: c_key_self !< Geometry iterator
