...
! ucldasv2 modules
use ucldasv2_fields_mod, only: ucldasv2_fields, ucldasv2_field
...
!! is postoned to then
type, public :: ucldasv2_getvalues
...
contains
  ...
  !> \copybrief ucldasv2_getvalues_create \see ucldasv2_getvalues_create
  procedure :: create => ucldasv2_getvalues_create

  !> \copybrief ucldasv2_getvalues_delete \see ucldasv2_getvalues_delete
  procedure :: delete => ucldasv2_getvalues_delete
  ...
  !> \copybrief ucldasv2_getvalues_getinterp \see ucldasv2_getvalues_getinterp
  procedure :: get_interp => ucldasv2_getvalues_getinterp

  !> \copybrief ucldasv2_getvalues_fillgeovals \see ucldasv2_getvalues_fillgeovals
  procedure :: fill_geovals=> ucldasv2_getvalues_fillgeovals

  !> \copybrief ucldasv2_getvalues_fillgeovals_ad \see ucldasv2_getvalues_fillgeovals_ad
  procedure :: fill_geovals_ad=> ucldasv2_getvalues_fillgeovals_ad
...
!!
!! \relates ucldasv2_getvalues_mod::ucldasv2_getvalues
subroutine ucldasv2_getvalues_create(self, geom, locs)
  class(ucldasv2_getvalues), intent(inout) :: self
  type(ucldasv2_geom),          intent(in) :: geom  !< remove this, not used?
...
end subroutine ucldasv2_getvalues_create
...
!! \relates ucldasv2_getvalues_mod::ucldasv2_getvalues
function ucldasv2_getvalues_getinterp(self, geom, grid, masked, locs) result(idx)
  class(ucldasv2_getvalues), intent(inout) :: self
  type(ucldasv2_geom),  target, intent(in) :: geom !< source geometry
...
!!
!! \relates ucldasv2_getvalues_mod::ucldasv2_getvalues
subroutine ucldasv2_getvalues_delete(self)
  class(ucldasv2_getvalues), intent(inout) :: self

  deallocate(self%horiz_interp)
  deallocate(self%horiz_interp_init)
end subroutine ucldasv2_getvalues_delete
...
!! \relates ucldasv2_getvalues_mod::ucldasv2_getvalues
subroutine ucldasv2_getvalues_fillgeovals(self, geom, fld, t1, t2, locs, geovals)
  class(ucldasv2_getvalues), intent(inout) :: self
  type(ucldasv2_geom),          intent(in) :: geom !< source grid to interp from
  class(ucldasv2_fields),       intent(in) :: fld !< the field to interpolate
  ...
  type(ucldasv2_field), pointer :: fldptr
  ...
  geovals%linit = .true.
end subroutine ucldasv2_getvalues_fillgeovals
...
!! \relates ucldasv2_getvalues_mod::ucldasv2_getvalues
subroutine ucldasv2_getvalues_fillgeovals_ad(self, geom, incr, t1, t2, locs, geovals)
  class(ucldasv2_getvalues), intent(inout) :: self
  type(ucldasv2_geom),          intent(in) :: geom !< target geometry
  class(ucldasv2_fields),    intent(inout) :: incr !< outout interpolated values
  type(datetime),           intent(in) :: t1 !< beginning of time window
  type(datetime),           intent(in) :: t2 !< ending of time window
...
end subroutine ucldasv2_getvalues_fillgeovals_ad

end module ucldasv2_getvalues_mod
